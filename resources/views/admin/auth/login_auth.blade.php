...
<body>
    <div class="log-w3">
        <div class="w3layouts-main">
            <h2>Đăng nhập tài khoản Authentication</h2>
            <?php
            //session_start();
            ...
            ?>
            <form action="{{URL::to('/login-auth-post')}}" method="post">
                {{ csrf_field() }}
    ...
    <!-- <div class="g-recaptcha" data-sitekey="{{env('CAPTCHA_KEY')}}"></div>
                ...
                <ul class="invalid-feedback" style="display:block;color: #e51111;font-size:13px;">
