                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            ...
                            ?>
                            <form action="{{URL::to('/save-banner')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="text-input" name="banner_ten" placeholder="Nhập tên banner..." class="form-control">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="file" id="text-input" name="banner_img" class="form-control">
                                    </div>
                                    @error('banner_img')
                                    <div class="col-lg-12 col-md-12" style="color: red;">
                                        <ul>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <select name="banner_trangthai" id="select" class="form-control">
