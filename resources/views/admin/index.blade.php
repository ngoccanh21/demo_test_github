...
<div class="main-content main-content--pb30">
    ...
    <div class="section__content section__content--p30">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <p class="title_thongke">Thống kê doanh số đơn hàng</p><br>

                    <form action="" autocomplete="off" class="col-lg-12">
                        @csrf
                        <div class="col-lg-3">
                        ...
                        <div class="col-lg-3">
                            <p>
                                Lọc theo:
                                <select class="index-filter form-control" name="" id="">
                                    <option>------------Chọn------------</option>
                ...
                <!-- biểu đồ morris lọc doanh số theo datepicker -->
                <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="overview-wrap">
                        <h2 class="title-1">Thống kê số lượng</h2>
                    ...
                    <div class="overview-item overview-item--c4">
                        <div class="overview__inner">
                            <div class="overview-box clearfix">
                                ...
                                <div class="text">
                                    <h2>{{number_format($tong_loinhuan,0,',','.')}}</h2>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="au-card chart-percent-card">
                        <div class="au-card-inner">
                            <h3 class="title-2 tm-b-5">Sản phẩm được xem nhiều</h3>
                            <div class="row no-gutters">
                                <div class="col-xl-12">
                                    <table>

                                        <tbody>
                                            @foreach($luotxem_sp as $index => $luotxem)
                                            <tr>
                                                <td>{{$index+1}} .</td>
                                                <td>
                                                    <div style="white-space: nowrap;overflow: hidden;text-overflow: ellipsis;width: 200px;">{{$luotxem->product_ten}}</div>
                                                </td>
                                                <td><span style="color: red;">{{$luotxem->product_luotxem}}</span> lượt xem</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                ...
                <div class="col-lg-6">
                    <div class="au-card chart-percent-card">
                        <div class="au-card-inner">
                            <h3 class="title-2 tm-b-5">Bài viết được xem nhiều</h3>
                            <div class="row no-gutters">
                                <div class="col-xl-12">
                                    <table>

                                        <tbody>
                                            @foreach($luotxem_tt as $index => $luotxem_t)
                                            <tr>
                                                <td>{{$index+1}} .</td>
                                                <td>
                                                    <div style="white-space: nowrap;overflow: hidden;text-overflow: ellipsis;width: 200px;">{{$luotxem_t->tintuc_tieude}}</div>
                                                </td>
                                                <td><span style="color: red;">{{$luotxem_t->tintuc_luotxem}}</span> lượt xem</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                ...
                <div class="col-lg-12">
                    <div class="au-card chart-percent-card">
                        <div class="au-card-inner">
                            <h3 class="title-2 tm-b-5">Thống kê số lượng</h3>
                            <div class="row no-gutters">
                                <div class="col-xl-6">
