            ...
            <div class="row h-100">
                <div class="col-lg-12">
                    <div class="breadcrumb-item">
                        <h2 class="breadcrumb-heading">Chi tiết sản phẩm giỏ hàng thường</h2>
                        <ul>
                            <li>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <a href="" class="single-img gallery-popup">
                                        <img class="img-full" src="/upload/product/{{$pro_detail->product_anh}}" style="width: 645px;height:555px;" alt="Product Image">
                                    </a>
                                </div>
                                <!-- <div class="swiper-slide">
                    ...
                    <div class="product-thumb-with-content row">
                        <div class="col-12 order-lg-1 order-2 pt-10 pt-lg-0">
                            <div class="single-product-content">
                                <h2 class="title">{{$pro_detail->product_ten}}</h2>
                                <div class="price-box pb-1">
                                    <span class="new-price text-danger">Giá bán: {{number_format($pro_detail->product_giaban)}} VND</span>
                                ...
                                <p class="short-desc mb-6">Mô tả giày: {{$pro_detail->product_mota}}</p>
                                <form action="{{url('/save-cart')}}" method="post">
                                    {{ csrf_field() }}
                                    <ul class="quantity-with-btn pb-7">
                                        <li class="quantity">
                                            <div class="cart-plus-minus">
                                                <input class="cart-plus-minus-box" value="1" type="text" min="1" name="qty">
                                                <input type="hidden" value="{{$pro_detail->product_id}}" name="product_id_hidden">
                                            </div>
                                        </li>
                                        <li class="add-to-cart">
                                            <button type="submit" class="btn btn-custom-size lg-size btn-primary btn-secondary-hover rounded-0">Thêm vào giỏ hàng</button>
                                        </li>
                                ...
                                <div class="swiper-slide">
                                    <div class="product-item">
                                        <div class="product-img img-zoom-effect">
                                            <a href="{{URL::to('/chi-tiet-san-pham/'.$sptt->product_id)}}">
