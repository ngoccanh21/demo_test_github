    ...
    <div class="container" style="background:#222;border-radius:12px;padding:15px;">
        <div class="col-md-12">
            ...
            <div class="row" style="background:cadetblue;padding:15px;">
                ...
                <div class="col-md-12">
                    <p style="color:#fff;font-size:17px;">Bạn đã đặt hàng bên shop với thông tin như sau:</p>
                    ...
                    <h4 style="text-transform: uppercase;color:#000;">Sản phẩm đã đặt bao gồm: </h4>
